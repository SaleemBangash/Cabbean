...
class LowRated extends StatefulWidget {
  const LowRated({Key? key}) : super(key: key);

  @override
  State<LowRated> createState() => _LowRatedState();
}

class _LowRatedState extends State<LowRated> {
  bool aChecked = false;
  bool bChecked = false;
  bool cChecked = false;
  bool dChecked = false;
